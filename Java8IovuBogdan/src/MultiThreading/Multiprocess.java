...
public class Multiprocess {
 ...
 pb.directory(new File(new F ile("")
"/Users/gheorgheaurelpacurar/Desktop/Training Java 8/JavaProjects/GheorgheAurelPacurar/JavaTraining/JavaTraining/build/classes/multithreading”)
);
 Process p1 = pb.start();
 Process p2 = pb.start();
